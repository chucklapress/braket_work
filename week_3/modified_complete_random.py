...
state_simulator = hadamard_circuit(n2_q)
simulator_task = simulator.run(state_simulator, shots=m2_s, poll_timeout_seconds=5*24*60*60)
...
if status_simulator == 'COMPLETED':
    ...
    array_simulator = simulator_results.measurements.reshape(1,m2_s*n2_q)
    print("The second raw bit string is: ",array_simulator)
